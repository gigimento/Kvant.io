    ...
    <div className="space-y-8 max-w-lg">
      <div>
        ...
        <p className="text-muted-foreground">
          Monitor brand mentions across AI platforms and analyze SEO performance.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Required for technical SEO audit and on-page analysis
              </p>
            </div>
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Used for AI-powered keyword research suggestions
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  placeholder="e.g. best marketing agency"
                  value={keyword}
