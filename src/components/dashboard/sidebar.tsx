...
import { FileText, Search, LayoutDashboard, CreditCard, Link2, LogOut, Settings, Globe, X } from "lucide-react"
...
const navItems = [
  ...
  { href: "/dashboard/brand-radar", label: "Brand Radar", icon: Search },
  { href: "/dashboard/geo-briefs", label: "GEO Briefs", icon: Globe },
  { href: "/dashboard/pdf-audit", label: "PDF Audit", icon: FileText },
